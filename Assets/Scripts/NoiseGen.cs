...
public static class NoiseGen {
    ...
    /// </summary>
    /// <param name="x">First dimension input value</param>
    ...
    /// <summary>
    /// Returns single Perlin noise value
    /// </summary>
    /// <param name="x">First dimension input value</param>
    /// <param name="y">Second dimension input value</param>
    /// <returns>Value between -1 and 1</returns>
    ...
    /// <param name="x">First dimension input value</param>
    /// <param name="y">Second dimension input value</param>
    /// <param name="z">Third dimension input value</param>
    /// <returns>Value between -1 and 1</returns>
    ...
    public static float Perlin(Vector3 coord) {
        return Perlin(coord.x, coord.y, coord.z);
    }
